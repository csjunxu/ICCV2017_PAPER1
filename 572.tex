...
Then, we can apply the proposed MC-WNNM model to $\mathbf{Y}_{j}$ to estimate $\mathbf{X}_{j}$ for color image denoising:
\vspace{-1mm}
\begin{equation}
\label{e10}
\vspace{-1mm}
