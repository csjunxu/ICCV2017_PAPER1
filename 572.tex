...
\mathbf{X}=\mathbf{Z}.
\end{equation}
Since the objective function is separable across the two variables, the problem (\ref{e10}) can be solved under the alternating direction method of multipliers (ADMM) \cite{admm} framework. We can derive its augmented Lagrangian function as:
\vspace{-1mm}
\begin{equation}
\label{e11}
\vspace{-1mm}
