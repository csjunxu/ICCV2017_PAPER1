...
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{br_kodim08_1.png}}
{\footnotesize (a) Clean Red Channel}
\end{minipage}
\begin{minipage}[t]{0.25\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{br_Noisy_nSig402030_kodim08_1}}
{\footnotesize (b) Noisy Red Channel}
\end{minipage}
\begin{minipage}[t]{0.25\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{br_kodim08_2.png}}
{\footnotesize (c) Clean Green Channel}
\end{minipage}
\begin{minipage}[t]{0.25\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{br_Noisy_nSig402030_kodim08_2.png}}
...
\begin{minipage}[t]{0.25\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{br_WNNMJ_nSig402030_lambda1_kodim08_1.png}}
{\footnotesize (e) Denoised Red by WNNM }
\end{minipage}
\begin{minipage}[t]{0.25\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{br_CWNNM_ADMM_nSig402030_kodim08_1.png}}
{\footnotesize (f) Denoised Red by MC-WNNM }
\end{minipage}
\begin{minipage}[t]{0.25\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{br_WNNMJ_nSig402030_lambda1_kodim08_2.png}}
{\footnotesize (g) Denoised Green by WNNM }
\end{minipage}
\begin{minipage}[t]{0.25\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{br_CWNNM_ADMM_nSig402030_kodim08_2.png}}
...
\vspace{-1mm}
%for solving the MC-WNNM model via ADMM
...
\includegraphics[width=1\textwidth]{resize_5dmark3_iso3200_1_real.png}
\end{minipage}
\begin{minipage}{0.08\textwidth}
\includegraphics[width=1\textwidth]{resize_5dmark3_iso3200_2_real.png}
\end{minipage}
\begin{minipage}{0.08\textwidth}
\includegraphics[width=1\textwidth]{resize_5dmark3_iso3200_3_real.png}
\end{minipage}
\begin{minipage}{0.08\textwidth}
\includegraphics[width=1\textwidth]{resize_d600_iso3200_1_real.png}
\end{minipage}
\begin{minipage}{0.08\textwidth}
\includegraphics[width=1\textwidth]{resize_d600_iso3200_2_real.png}
\end{minipage}
}\vspace{-3mm}
\subfigure{
\begin{minipage}{0.08\textwidth}
\includegraphics[width=1\textwidth]{resize_d600_iso3200_3_real.png}
\end{minipage}
\begin{minipage}{0.08\textwidth}
\includegraphics[width=1\textwidth]{resize_d800_iso1600_1_real.png}
\end{minipage}
\begin{minipage}{0.08\textwidth}
\includegraphics[width=1\textwidth]{resize_d800_iso1600_2_real.png}
\end{minipage}
\begin{minipage}{0.08\textwidth}
\includegraphics[width=1\textwidth]{resize_d800_iso1600_3_real.png}
\end{minipage}
\begin{minipage}{0.08\textwidth}
\includegraphics[width=1\textwidth]{resize_d800_iso3200_1_real.png}
\end{minipage}
}\vspace{-3mm}
\subfigure{
\begin{minipage}{0.08\textwidth}
\includegraphics[width=1\textwidth]{resize_d800_iso3200_2_real.png}
\end{minipage}
\begin{minipage}{0.08\textwidth}
\includegraphics[width=1\textwidth]{resize_d800_iso3200_3_real.png}
\end{minipage}
\begin{minipage}{0.08\textwidth}
\includegraphics[width=1\textwidth]{resize_d800_iso6400_1_real.png}
\end{minipage}
\begin{minipage}{0.08\textwidth}
\includegraphics[width=1\textwidth]{resize_d800_iso6400_2_real.png}
\end{minipage}
\begin{minipage}{0.08\textwidth}
\includegraphics[width=1\textwidth]{resize_d800_iso6400_3_real.png}
\end{minipage}
}\vspace{-1mm}
...
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_Noisy_dog.png}}
{\footnotesize (a) Noisy \cite{ncwebsite}   }
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_BM3D_dog.png}}
{\footnotesize (b) CBM3D \cite{cbm3d}  }
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_MLP_dog.png}}
{\footnotesize (c) MLP \cite{mlp}  }
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_TRD_dog.png}}
{\footnotesize (d) TNRD \cite{chen2015learning}}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_NI_dog.png}}
...
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_NC_dog.png}}
{\footnotesize (f) NC \cite{noiseclinic,ncwebsite}   }
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_WNNM_dog.png}}
{\footnotesize (g) WNNM-1 \cite{wnnm}   }
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_WNNMJ_dog.png}}
{\footnotesize (h) WNNM-2 \cite{wnnm}   }
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_WNNM_ADMM_dog.png}}
{\footnotesize (i) WNNM-3 \cite{wnnm}   }
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_CWNNM_ADMM_NL_dog.png}}
...
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_Noisy_d800_iso6400_2.png}}
{\footnotesize (a) Noisy  \cite{crosschannel2016}: 29.97dB }
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_CBM3D_CC15_d800_iso6400_2.png}}
{\footnotesize (b) CBM3D \cite{bm3d,cbm3d}: 31.22dB}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_TRD_CC15_d800_iso6400_2.png}}
{\footnotesize (c) TNRD \cite{chen2015learning}: 32.33dB  } 
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_NI_CC15_d800_iso6400_2.png}}
{\footnotesize (d) NI \cite{neatimage}: 32.13dB  }
\end{minipage}
\centering
\begin{minipage}[t]{0.19\textwidth}
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_NC_CC15_d800_iso6400_2.png}}
...
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_CC_d800_iso6400_2.png}}
{\footnotesize (f) CC \cite{crosschannel2016}: 33.21dB }
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_WNNMJ_CC15_d800_iso6400_2.png}}
{\footnotesize (g) WNNM-2: 33.61dB}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_WNNM_ADMM_NL_CC15_d800_iso6400_2.png}}
{\footnotesize (h) WNNM-3: 33.43dB}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_CWNNM_ADMM_NL_CC15_d800_iso6400_2.png}}
{\footnotesize (i) MC-WNNM: \textbf{33.95}dB}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{resize_br_d800_iso6400_2.png}}
