...
\section{Experiments}
In this section, we demonstrate the effectiveness of the proposed multi-channel WNNM model on color image denoising problem. We first apply the proposed method on synthetic noisy images with additive white Gaussian noise with different standard deviations. Then we evaluate the proposed mehtod on recently proposed dataset of real noisy images with ``ground truth'' clean images \cite{crosschannel2016}.
